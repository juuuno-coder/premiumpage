...
export const DB: Record<string, any[]> = {
    ...
    humidity: [
        ...
        { id: 'hmdw110', title: 'HMDW110', subtitle: 'IP65', category: 'hvac', image: '/hstech/HMDW110_files/3b230a65bef40.png', gallery: ["/hstech/HMDW110_files/3b230a65bef40.png", "/hstech/HMDW110_files/4b5480e31f81b.png"], desc: 'IP65 transmitter.', specs: [{ label: 'Measurement range', value: `RH & T` }, { label: 'RH range', value: `0…100% RH` }, { label: 'Temp', value: `Temperature` }, { label: 'range', value: `-40..+60°CCalculated Parameters` }, { label: 'Enthalpy', value: `40 ...` }, { label: 'Accuracy', value: `460 kJ/kgAccuracy` }, { label: 'IP', value: '65' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMDW110-Datasheet-B211705EN.pdf' },
