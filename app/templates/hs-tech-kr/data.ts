...
export const DB: Record<string, any[]> = {
    ...
    humidity: [
        ...
        { id: 'hmt360', title: 'HMT360', subtitle: 'Ex-Proof', category: 'industrial', image: '/hstech/HMT360_files/ffb709fd729cd.png', gallery: ["/hstech/HMT360_files/ffb709fd729cd.png", "/hstech/HMT360_files/08da9ee263466.jpg", "/hstech/HMT360_files/6b84ea881fad7.png", "/hstech/HMT360_files/2fcdf2496223e.jpg", "/hstech/HMT360_files/4c75cd7f13af5.png"], desc: 'Intrinsically safe.', specs: [{ label: 'RH range', value: `0…100% RHTemperature range -40...+60°C(-40...+140°F)Probe diameter 12 mm` }, { label: 'Accuracy', value: `Accuracy` }, { label: 'Output', value: `± 0.2ºC @ 20ºC PT1000Output` }, { label: '2', value: `Wire Current` }, { label: 'IP', value: `(4…20mA)IP rating` }, { label: 'Temp', value: `Storage temperature` }], desc: 'Intrinsically safe.', specs: [{ label: 'Zone', value: '0' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMT360-Datasheet-B211737EN.pdf' },
        { id: 'hmd60', title: 'HMD60', subtitle: 'Duct Mount', category: 'hvac', image: '/hstech/HMD60_files/21b4bdad4a29e.png', gallery: ["/hstech/HMD60_files/21b4bdad4a29e.png", "/hstech/HMD60_files/84fb2f49cb789.png"], desc: 'Duct mount HVAC.', specs: [{ label: 'Probe length', value: `250mm (HMD60/TMD60 can select 100mm short probe)` }, { label: 'IP', value: `IP66(NEMA 4X)` }, { label: 'Measurement range', value: `RH & T` }, { label: 'RH range', value: `0…100%` }, { label: 'Temp', value: `Temperature` }, { label: 'range', value: `-20..+80°C (-4...+176°F)Accuracy` }], desc: 'Duct mount HVAC.', specs: [{ label: 'Acc', value: '1.5%' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMD60-Datasheet-B211704EN.pdf' },
        { id: 'hmw90', title: 'HMW90', subtitle: 'Wall Mount', category: 'hvac', image: '/hstech/HMW90_files/626f320e9c53f.png', gallery: ["/hstech/HMW90_files/626f320e9c53f.png", "/hstech/HMW90_files/2fdd5444d44e3.png"], desc: 'Wall mount HVAC.', specs: [{ label: 'On', value: `site calibration` }, { label: 'Housing', value: `IP30` }, { label: 'range', value: `T only` }, { label: 'Temperature range', value: `-5...+55°C (-23...+131 °F)Accuracy` }, { label: 'RH range', value: `0…100% RH` }, { label: 'Temp', value: `Temperature` }], desc: 'Wall mount HVAC.', specs: [{ label: 'Use', value: 'Indoor' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMW90-Datasheet-B211703EN.pdf' },
        { id: 'hmdw110', title: 'HMDW110', subtitle: 'IP65', category: 'hvac', image: '/hstech/HMDW110_files/3b230a65bef40.png', gallery: ["/hstech/HMDW110_files/3b230a65bef40.png", "/hstech/HMDW110_files/4b5480e31f81b.png"], desc: 'IP65 transmitter.', specs: [{ label: 'Measurement range', value: `RH & T` }, { label: 'RH range', value: `0…100% RH` }, { label: 'Temp', value: `Temperature` }, { label: 'range', value: `-40..+60°CCalculated Parameters` }, { label: 'Enthalpy', value: `40 ...` }, { label: 'Accuracy', value: `460 kJ/kgAccuracy` }], desc: 'IP65 transmitter.', specs: [{ label: 'IP', value: '65' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMDW110-Datasheet-B211705EN.pdf' },
        ...
        { id: 'hmt330', title: 'HMT330', subtitle: 'Flagship', category: 'industrial', image: '/hstech/HMT330_files/6d2ba9e2a3f71.png', gallery: ["/hstech/HMT330_files/6d2ba9e2a3f71.png", "/hstech/HMT330_files/6b84ea881fad7.png", "/hstech/HMT330_files/cffbaca7b6b82.jpg"], desc: 'Top industrial transmitter.', specs: [{ label: 'RH range', value: `0…100% RHTemperature range:  -40...+60°C` }, { label: '(', value: `40...+140°F)` }, { label: 'Variables(Model', value: `Dependent)Dew point temperature, mixing ratio, absolute` }, { label: 'Accuracy', value: `humidity, wet bulb temperature, enthalpy, water vapor pressureAccuracy` }, { label: 'Output', value: `100 ... 240 VAC,  50/60 HZOutput` }, { label: 'Voltage outputs', value: `0…` }], desc: 'Top industrial transmitter.', specs: [{ label: 'Acc', value: '1%' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMT330-Datasheet-B211735EN.pdf' },
        { id: 'hmt310', title: 'HMT310', subtitle: 'Compact', category: 'industrial', image: '/hstech/HMT310_files/3f0c5783f8d85.png', gallery: ["/hstech/HMT310_files/3f0c5783f8d85.png", "/hstech/HMT310_files/0a9dc3cf1ab69.png"], desc: 'Compact transmitter.', specs: [{ label: 'RH range', value: `0…100% RHTemperature range:  -40...+60°C` }, { label: '(', value: `40...+140°F)` }, { label: 'Accuracy', value: `Accuracy` }, { label: 'Output', value: `± 0.2ºC @ 20ºC PT1000Operating voltage12...28V (with serial port 15...28V)Output` }, { label: 'RS', value: `232 in one M12/8 pin connectorIP rating` }, { label: 'IP', value: `IP65 with local` }], desc: 'Compact transmitter.', specs: [{ label: 'Size', value: 'Small' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMT310-Datasheet-B211734EN.pdf' },
        { id: 'hmt120', title: 'HMT120', subtitle: 'Standard', category: 'industrial', image: '/hstech/HMT120_files/8a6f9fcd6843b.png', gallery: ["/hstech/HMT120_files/8a6f9fcd6843b.png", "/hstech/HMT120_files/aff8250c900e2.png"], desc: 'Standard transmitter.', specs: [{ label: 'Range', value: `Measurement range` }, { label: 'RH range', value: `0…100%` }, { label: 'Temp', value: `Temperature` }, { label: 'range', value: `-40..+80°C (-40...+176°F)Other Variables(Optional)Dew point/frost point, mixing ratio, absolute humidity, wet bulb` }, { label: 'Accuracy', value: `temperature, enthalpy, vapor pressure, saturation vapor pressureAccuracy` }, { label: 'IP', value: `± 0.2ºC @ 20ºC PT1000IP rating` }], desc: 'Standard transmitter.', specs: [{ label: 'Probe', value: 'Interchangeable' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/HMT120-Datasheet-B211733EN.pdf' }
    ],
    dewpoint: [
