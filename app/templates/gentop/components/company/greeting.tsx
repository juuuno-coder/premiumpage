    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-4 md:py-8">
            <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12 items-start">
                ...
                <div className="lg:col-span-7 space-y-5 text-gray-800 leading-relaxed text-sm md:text-base">
                    ...
                    <p className="text-base md:text-lg font-black text-slate-900 pt-4">
                        Thank you.
                    </p>

                    <p className="text-right font-bold text-[#F47920] pt-2">
