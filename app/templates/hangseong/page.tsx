                        ...
                        <div className="lg:col-span-12 space-y-10 px-2 lg:px-4">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
                                    {/* Description */}
                                    <div className="lg:col-span-5 prose dark:prose-invert max-w-none text-lg leading-relaxed text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-900/50 p-8 rounded-3xl border border-slate-200 dark:border-white/5 shadow-sm h-full flex flex-col">
                                    ...
                                    {/* Specs Table */}
                                    <div className="lg:col-span-7 space-y-6 bg-slate-50 dark:bg-slate-900/50 p-8 rounded-3xl border border-slate-200 dark:border-white/5 shadow-sm h-full flex flex-col">
