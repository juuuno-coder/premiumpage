        ...
        systems: [
            {
                ...
                recommendedProducts: ['hmp8', 'hmt140', 'rfl100', 'ptb210', 'gmp251', 'dl2000', 'dl1000', 'dl1016', 'dl4000']
            },
            {
                title: '2. Incubator Monitoring',
                desc: `Monitor and measure your medical, pharmaceutical, and biotechnical incubators with Vaisala monitoring solutions for incubators. Designed for GxP applications, the Vaisala viewLinc monitoring system and devices ensure regulatory compliance, and provide assurance of accurate test and process results. The system offers: Industry-best sensors with easy-to-use software to reduce the risk of failed tests and incubation processes. Low cost-of-ownership due to easy connectivity via PoE, Wi-Fi, or Ethernet. Scalability up to thousands of monitored locations. Gap-free and protected data records for compliance with GxP. 24/7 remote alarming via SMS, e-mail, and more. Custom reports can be scheduled and automatically delivered by email, or generated on demand. Comprehensive IQOQ validation and on-site installation services ensure a smooth start-up and higher productivity. Vaisala also offers hand-held CO2, humidity and temperature meters for spot-checking and OEM modules and probes for incubator manufacturers.`,
                recommendedProducts: ['hmm105', 'hms110', 'hmt140', 'hm70', 'dmt340', 'rfl100', 'ptb210', 'gmp251', 'gmp231', 'gm70', 'ptb330ts', 'dl2000', 'dl1000', 'dl1016', 'dl4000']
            },
            {
                title: '3. Laboratory Monitoring',
                desc: `Reduce the risk of imprecise measurements and failed audits in your accredited calibration laboratories and metrological applications with Vaisala solutions. The Vaisala viewLinc continuous monitoring system offers: Significant savings in operating expense over chart recorders and hygrothermographs. Low cost-of-ownership due to easy network connectivity and scalability to thousands of monitored locations. Gap-free and protected data records ensure you always know what's happening in the laboratory, even in the event of power outage or network downtime. 24/7 remote alarming via SMS, email, pager and other types of alerts. Custom reports can be scheduled and automatically emailed, or generated on demand. Fast and easy IQOQ validation and on-site installation services for smooth start-up and higher productivity. Vaisala also offers wide range of hand-held humidity and temperature meters for spot-checking and on-site transmitter calibrations.`,
                recommendedProducts: ['hmt330', 'hmw90', 'gmw90', 'hmt140', 'hm70', 'rfl100', 'ptb210', 'gmp251', 'dl2000', 'dl1000']
            },
            {
                title: '4. Hospital Pharmacy Monitoring',
                desc: `Reduce the risk of lost product and regulatory non-compliance in your hospital pharmacy environments, ORs, procedure rooms, blood and tissue banks, and labs. Monitoring System Features: Gap-free data recording with complete audit trail. Battery-powered data loggers function up to 10 years and have large on-board memory for immunity to network failures and power outages. Remote alarming via SMS, email, flashing PC alert, and other alerting mechanisms. Fast, simple installation and validation - with our IQOQ documents or validation service. Scalable from one to thousands of monitored points. Software and devices were designed to ensure you comply with Part 11 and Annex 11 requirements. Saves on IT and installation costs by connecting easily to any standard network via Ethernet, Power over Ethernet, wireless, or Wi-Fi.`,
                recommendedProducts: ['hmt330', 'hmt140', 'hm70', 'rfl100', 'pdt101', 'gmp251', 'hpp271', 'dl2000', 'dl1000', 'dl1016']
            },
            {
                title: '5. Warehouse Monitoring',
                desc: `Reduce the risk of non-compliance and lost products in your GDP-compliant holding areas with Vaisala solutions for warehouses and distribution centers. The Vaisala viewLinc continuous monitoring system offers: Low cost-of-ownership thanks to easy connectivity - wired, PoE, Wi-Fi or Vaisala's proprietary wireless technology VaiNet. Gap-free and protected data records for compliance with Good Distribution Practice. 24/7 remote alarming via SMS, email, or local alerts. Custom reports that are automatically generated and delivered by email on demand. Fast and easy IQOQ validation documents, or on-site installation/validation services for smooth start-up. Rugged, highly accurate data loggers allow for mapping/validation studies with the same equipment.`,
                recommendedProducts: ['hmt330', 'rfl100', 'dmt340', 'hmt120', 'hmt360', 'hmt140', 'hmd60', 'hmdw110', 'dl2000', 'dl1016']
            },
            {
                title: '6. Cleanroom Monitoring',
                desc: `Cleanrooms and other critical environments require high performance environmental measurements to operate consistently and within specifications. Humidity and temperature measurement can be especially challenging in a cleanroom environment. Vaisala's highly accurate instruments and robust solutions address measurement challenges and help keep your cleanroom facilities running smoothly. Low cost of ownership due to easy connectivity to your existing network, remote access, and scalability up to thousands of monitored locations. Both wired and wireless sensor options available, including Vaisala's proprietary wireless technology - VaiNet. Customizable reporting for easy cleanroom certification and classifications. Gap-free and protected data records required in GxP environments. Audible and visual alarms, as well as alarming via SMS, e-mail, pager and many more. Custom reports that are automatically generated and delivered by email on demand. Measurement of humidity, temperature, differential pressure, flow, particulate and more. Fast and easy IQOQ validation and on-site installation services for smooth start-up and higher productivity.`,
                recommendedProducts: ['hmp1_9', 'hmt330', 'hmt120', 'hmt140', 'hmdw110', 'rfl100', 'hpp271', 'dl2000', 'dl1000', 'dl1016']
            },
            {
                title: '7. Stability Chamber Monitoring',
                desc: `Vaisala stability chamber monitoring solutions provide independent real-time trends and audit trails with flexible alarming and customizable reporting. Vaisala reduces the risk of non-compliance with the requirements of the ICH and FDA for monitoring temperature, relative humidity, and other critical parameters. The Vaisala viewLinc continuous monitoring system offers: Industry-leading data loggers and instrumentation. Low cost-of-ownership with easy set-up, or installation and validation services. Scalability to thousands of monitored locations. Gap-free and protected data records for compliance with GxP standards and regulations. 24/7 remote alarming via SMS, e-mail and other alerting mechanisms. Custom reports can be scheduled and automatically delivered by email. Reports can also be generated on-demand and exported to spreadsheets for manipulation and analysis. Fast and easy IQOQ (sample) and GxP documentation for compliance. A range of hand-held humidity and temperature meters for spot-checking.`,
                recommendedProducts: ['hmp7', 'rfl100', 'hmt120', 'hmm105', 'hms110', 'gmp343', 'gmp251', 'ptb330ts', 'dl1016', 'dl4000']
            },
            {
                title: '8. Pharmaceutical (Nutraceutical) Manufacturing',
                desc: `Vaisala solutions reduce the risk of lost product and regulatory non-compliance in DSHEA-compliant nutraceutical manufacturing facilities, warehouses, and distribution centers. The Vaisala continuous monitoring system offers: Low cost-of-ownership with easy network connectivity and scalability to thousands of monitored locations. Gap-free and protected data records for compliance with GxP. 24/7 remote alarming via SMS, email, pager and many more to reduce the risk of lost products. Custom reports can be scheduled and automatically emailed, or generated on demand. On-board memory and power ensures data integrity in case of power outage and network downtime. Wireless options make loggers easy to place where electrical outlets are not feasible. Fast and easy IQOQ validation and on-site installation services for smooth start-up and higher productivity. Vaisala also offers wide range of hand-held humidity and temperature meters for spot-checking and on-site transmitter calibrations.`,
                recommendedProducts: ['hmt330', 'hmp1_9', 'hmt120', 'rfl100', 'ptb210', 'ptb330ts', 'gmp251', 'hpp271', 'dl2000', 'dl1000', 'dl1016', 'dl4000']
            },
            {
                title: '9. Environmental Mapping Qualification',
                desc: `For temperature and humidity qualification of GxP environments A reliable, easy-to-use alternative to thermocouple-based equipment, bulky data acquisition systems, and less robust data loggers. Ideal for stability chambers, refrigerators, freezers, incubators, warehouses, ambient environments and other demanding studies. The mapping kit comprises the vLog VL software, vLog's IQOQ, and Vaisala's data loggers including: Temperature: -90 to 70 °C, up to 0.1 °C accuracy and 0.02 °C resolution vLog IQ / OQ Protocol. Relative Humidity: 10 to 90 % RH up to 1 % accuracy and 0.05 % resolution. Measurement accuracy specified for one year, eliminating the need for frequent calibration.`,
                recommendedProducts: ['hmt140', 'rfl100', 'dl2000', 'dl1000', 'dl1016', 'dl4000']
            }
        ],
        externalLink: 'http://www.vaisala.com/en/lifescience/applications/refrigeratorandfreezermonitoring/Pages/default.aspx'
    }
