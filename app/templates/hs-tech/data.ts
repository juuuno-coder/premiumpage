...
export const DB: Record<string, any[]> = {
    ...
    weather: [
        { id: 'wxt530', title: 'WXT530', subtitle: 'WEATHER STATION', category: 'trans', image: '/hstech/HS-TECH_files/2c2344f8b46d5.jpg', gallery: ['/hstech/HS-TECH_files/2c2344f8b46d5.jpg'], desc: 'All-in-one multi-parameter weather sensor.', specs: [{ label: 'Parameters', value: 'Wind, Rain, P, T, RH' }, { label: 'Application', value: 'Weather monitoring, Aviation' }] },
        { id: 'hmp155_w', title: 'HMP155', subtitle: 'WEATHER PROBE', category: 'trans', image: '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg', gallery: ['/hstech/HS-TECH_files/2ddb0a75a50e4.jpg'], desc: 'High-accuracy humidity and temperature probe for weather applications.', specs: [{ label: 'Accuracy', value: '±1.0 %RH' }, { label: 'Application', value: 'Meteorology, Roads' }] }
    ],
    h2o2: [
