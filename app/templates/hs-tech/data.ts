...
export const CATEGORY_INFO: Record<string, any> = {
    ...
    dewpoint: { title: "Dewpoint", desc: "Reliable dewpoint measurement.", images: ['/hstech/HS-TECH_files/38af1f4961a7a.png', '/hstech/HS-TECH_files/50e31ebdea359.png'] },
    co2: { title: "Carbon Dioxide", desc: "Accurate CO2 monitoring.", images: ['/hstech/HS-TECH_files/6251932a0e954.png', '/hstech/HS-TECH_files/eb130aca3df08.png'] },
    oil: { title: "Moisture in Oil", desc: "Transformer oil monitoring.", images: ['/hstech/HS-TECH_files/deffa2b1b398f.jpg', '/hstech/HS-TECH_files/5980bfb1851a8.png'] },
    barometer: { title: "Barometric Pressure", desc: "Digital barometers.", images: ['/hstech/HS-TECH_files/3ca83569b6d00.jpg'] },
    weather: { title: "Weather", desc: "Meteorological sensors.", images: ['/hstech/HS-TECH_files/2c2344f8b46d5.jpg', '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg'] },
    h2o2: { title: "H2O2", desc: "Bio-decontamination monitoring.", images: ['/hstech/HS-TECH_files/47e994f808c6a.png'] },

    // Brands
    setra: { title: "SETRA Systems", desc: "Differential & Industrial Pressure.", images: ['/hstech/HVAC_files/0173971661ad2.png', '/hstech/HVAC_files/849fee28dfdc5.png'] },
    jumo: { title: "JUMO", desc: "Liquid Analysis & Control.", images: ['/hstech/HS-TECH_files/94259b4509a1f.png', '/hstech/HS-TECH_files/85b44cdd77766.png'] },
    knick: { title: "KNICK", desc: "Process Analysis.", images: ['/hstech/HS-TECH_files/322e267fafb41.png'] },
...
export const DB: Record<string, any[]> = {
    ...
    dewpoint: [
        { id: 'dmp1', title: 'DMP1-8', subtitle: 'DEWPOINT PROBE SERIES', category: 'fixed', image: '/hstech/HS-TECH_files/38af1f4961a7a.png', gallery: ['/hstech/HS-TECH_files/38af1f4961a7a.png'], desc: 'Intelligent dewpoint probes for compressed air and industrial drying.', specs: [{ label: 'Range', value: '-60...+60 °Ctd' }, { label: 'Application', value: 'Dryers, Cleanrooms, Compressed air' }] },
        { id: 'dmt340', title: 'DMT340', subtitle: 'DEWPOINT TRANSMITTER', category: 'fixed', image: '/hstech/HS-TECH_files/50e31ebdea359.png', gallery: ['/hstech/HS-TECH_files/50e31ebdea359.png'], desc: 'Dewpoint transmitter for condensing environments.', specs: [{ label: 'Application', value: 'Condensing environments' }, { label: 'Features', value: 'Heated sensor head' }] },
        { id: 'dmt345', title: 'DMT345/346', subtitle: 'HIGH TEMP DEWPOINT', category: 'fixed', image: '/hstech/HS-TECH_files/5cf3bcd453c32.png', gallery: ['/hstech/HS-TECH_files/5cf3bcd453c32.png'], desc: 'High temperature dewpoint transmitter for demanding applications.', specs: [{ label: 'Temp', value: 'Up to +180 °C' }, { label: 'Application', value: 'Plastic dryers, Industrial ovens' }] },
        { id: 'dmt132', title: 'DMT132', subtitle: 'DEWPOINT HUMIDITY MODULE', category: 'module', image: '/hstech/HS-TECH_files/2d44fea596554.png', gallery: [], desc: 'OEM dewpoint and humidity module for integration into instruments and systems.', specs: [{ label: 'Type', value: 'OEM Module' }, { label: 'Range', value: '-60...+60 °Ctd' }, { label: 'Output', value: 'Analog / Digital' }, { label: 'Application', value: 'OEM integration, Instruments' }] },
        { id: 'dmt152', title: 'DMT152', subtitle: 'LOW DEWPOINT MODULE', category: 'module', image: '/hstech/HS-TECH_files/2d44fea596554.png', gallery: ['/hstech/HS-TECH_files/2d44fea596554.png'], desc: 'OEM module for low dewpoint measurement.', specs: [{ label: 'Range', value: 'Down to -80 °Ctd' }, { label: 'Application', value: 'OEM, Dry air systems' }] },
        { id: 'dmt143', title: 'DMT143', subtitle: 'COMPACT OEM MODULE', category: 'module', image: '/hstech/HS-TECH_files/6d596692e24f1.png', gallery: ['/hstech/HS-TECH_files/6d596692e24f1.png'], desc: 'Compact dewpoint module for OEM applications.', specs: [{ label: 'Size', value: 'Ultra-compact' }, { label: 'Output', value: 'Analog & Digital' }] },
        { id: 'dmt143l', title: 'DMT143L', subtitle: 'EXTENDED PROBE', category: 'module', image: '/hstech/HS-TECH_files/289587707561d.png', gallery: ['/hstech/HS-TECH_files/289587707561d.png'], desc: 'DMT143 with extended probe length.', specs: [{ label: 'Probe', value: 'Extended length' }, { label: 'Application', value: 'Deep installations' }] },
        { id: 'dpt146', title: 'DPT146', subtitle: 'DEWPOINT & PRESSURE', category: 'module', image: '/hstech/HS-TECH_files/f038c293907b8.png', gallery: ['/hstech/HS-TECH_files/f038c293907b8.png'], desc: 'Combined dewpoint and pressure measurement.', specs: [{ label: 'Dual', value: 'Td + P measurement' }, { label: 'Application', value: 'Compressed air systems' }] },
        { id: 'dpt145', title: 'DPT145', subtitle: 'SF6 GAS MONITOR', category: 'module', image: '/hstech/HS-TECH_files/04ad79c254fa2.png', gallery: ['/hstech/HS-TECH_files/04ad79c254fa2.png'], desc: 'Dewpoint measurement in SF6 gas systems.', specs: [{ label: 'Gas', value: 'SF6 compatible' }, { label: 'Application', value: 'High voltage switchgear' }] },
        { id: 'indigo80_dmp80', title: 'Indigo80+DMP80', subtitle: 'PORTABLE DEWPOINT', category: 'portable', image: '/hstech/HS-TECH_files/1388fffe59c2e.png', gallery: ['/hstech/HS-TECH_files/1388fffe59c2e.png'], desc: 'Portable dewpoint measurement system with Indigo indicator.', specs: [{ label: 'System', value: 'Indicator + Probe' }, { label: 'Application', value: 'Spot-checking, Calibration' }] },
        { id: 'dm70', title: 'DM70', subtitle: 'HANDHELD DEWPOINT', category: 'portable', image: '/hstech/HS-TECH_files/fc840485431f5.png', gallery: ['/hstech/HS-TECH_files/fc840485431f5.png'], desc: 'Professional handheld dewpoint meter.', specs: [{ label: 'Accuracy', value: '±2 °Ctd' }, { label: 'Application', value: 'Field measurement' }] },
        { id: 'dss70a', title: 'DSS70A', subtitle: 'SAMPLING SYSTEM', category: 'portable', image: '/hstech/HS-TECH_files/96ddd2e578412.png', gallery: ['/hstech/HS-TECH_files/96ddd2e578412.png'], desc: 'Sampling cell for use with DM70.', specs: [{ label: 'Use with', value: 'DM70 meter' }, { label: 'Application', value: 'Pressurized gas sampling' }] }
    ],
    co2: [
        { id: 'gmw90', title: 'GMW90', subtitle: 'WALL TRANSMITTER', category: 'transmitter', image: '/hstech/HS-TECH_files/6251932a0e954.png', gallery: ['/hstech/HS-TECH_files/6251932a0e954.png'], desc: 'CO2, temperature and humidity transmitter for indoor environments.', specs: [{ label: 'Parameters', value: 'CO2 + T + RH' }, { label: 'Application', value: 'HVAC, Building automation' }] },
        { id: 'gmw80', title: 'GMW80', subtitle: 'BASIC CO2 TRANSMITTER', category: 'transmitter', image: '/hstech/HS-TECH_files/cfd2828db31bd.png', gallery: ['/hstech/HS-TECH_files/cfd2828db31bd.png'], desc: 'Economical CO2 transmitter for standard applications.', specs: [{ label: 'Parameter', value: 'CO2 only' }, { label: 'Range', value: '0...2000 ppm' }] },
        { id: 'gmd110', title: 'GMD110', subtitle: 'DUCT TRANSMITTER', category: 'transmitter', image: '/hstech/HS-TECH_files/c846ecca3733c.png', gallery: ['/hstech/HS-TECH_files/c846ecca3733c.png'], desc: 'CO2 transmitter for duct mounting in HVAC systems.', specs: [{ label: 'Installation', value: 'Duct mount' }, { label: 'Application', value: 'Demand control ventilation' }] },
        { id: 'gmp343', title: 'GMP343', subtitle: 'INDUSTRIAL CO2 PROBE', category: 'probe', image: '/hstech/HS-TECH_files/eb130aca3df08.png', gallery: ['/hstech/HS-TECH_files/eb130aca3df08.png'], desc: 'Robust CO2 probe for industrial processes.', specs: [{ label: 'Flow', value: 'Flow-through design' }, { label: 'Range', value: '0...10000 ppm' }] },
        { id: 'gmp251', title: 'GMP251', subtitle: 'HIGH RANGE CO2 PROBE', category: 'probe', image: '/hstech/HS-TECH_files/f6933d55699f3.png', gallery: ['/hstech/HS-TECH_files/f6933d55699f3.png'], desc: 'CO2 probe for percent-level measurement.', specs: [{ label: 'Range', value: '0...30 %vol' }, { label: 'Application', value: 'Incubators, Controlled atmosphere' }] },
        { id: 'gmp231', title: 'GMP231', subtitle: 'INCUBATOR PROBE', category: 'probe', image: '/hstech/HS-TECH_files/8b82ea8dea629.png', gallery: ['/hstech/HS-TECH_files/8b82ea8dea629.png'], desc: 'CO2 probe specially designed for incubators.', specs: [{ label: 'Temp', value: 'Up to +180 °C' }, { label: 'Application', value: 'Life science incubators' }] },
        { id: 'indigo80_gmp252', title: 'Indigo80+GMP252', subtitle: 'PORTABLE CO2 METER', category: 'handheld', image: '/hstech/HS-TECH_files/41a5c8353e901.png', gallery: ['/hstech/HS-TECH_files/41a5c8353e901.png'], desc: 'Portable CO2 measurement system with percent-level accuracy.', specs: [{ label: 'Range', value: '0...30 %vol (ppm available)' }, { label: 'Application', value: 'Spot-checking, Calibration' }] }
    ],
    oil: [
        { id: 'mht410', title: 'MHT410', subtitle: 'TRANSFORMER MONITOR', category: 'transformer', image: '/hstech/HS-TECH_files/deffa2b1b398f.jpg', gallery: ['/hstech/HS-TECH_files/deffa2b1b398f.jpg'], desc: 'Online monitoring of moisture and hydrogen in transformer oil.', specs: [{ label: 'Parameters', value: 'H2O + H2' }, { label: 'Application', value: 'Power transformers' }] },
        { id: 'mmt330', title: 'MMT330', subtitle: 'OIL TRANSMITTER', category: 'fixed', image: '/hstech/HS-TECH_files/5980bfb1851a8.png', gallery: ['/hstech/HS-TECH_files/5980bfb1851a8.png'], desc: 'Online moisture measurement in insulating oils.', specs: [{ label: 'Oil types', value: 'Mineral, Synthetic, Ester' }, { label: 'Application', value: 'Transformer monitoring' }] },
        { id: 'mmt310', title: 'MMT310', subtitle: 'COMPACT OIL TRANSMITTER', category: 'fixed', image: '/hstech/HS-TECH_files/3ca83569b6d00.jpg', gallery: ['/hstech/HS-TECH_files/3ca83569b6d00.jpg'], desc: 'Compact transmitter for oil moisture measurement.', specs: [{ label: 'Size', value: 'Compact design' }, { label: 'Application', value: 'Small transformers, OEM' }] },
        { id: 'mm70', title: 'MM70', subtitle: 'HANDHELD OIL METER', category: 'handheld', image: '/hstech/HS-TECH_files/a39c6508f2ff2.png', gallery: ['/hstech/HS-TECH_files/a39c6508f2ff2.png'], desc: 'Portable instrument for spot-checking oil moisture.', specs: [{ label: 'Application', value: 'Field measurement' }, { label: 'Feature', value: 'Fast response' }] },
        { id: 'mmt162', title: 'MMT162', subtitle: 'OEM OIL MOISTURE MODULE', category: 'oil_module', image: '/hstech/HS-TECH_files/deffa2b1b398f.jpg', gallery: [], desc: 'Compact OEM module for continuous oil moisture measurement in transformers and industrial machinery.', specs: [{ label: 'Type', value: 'OEM / Module' }, { label: 'Application', value: 'Transformers, Hydraulic systems, Industrial oil' }, { label: 'Output', value: '4...20 mA, Modbus' }] }
    ],
    barometer: [
        { id: 'ptb330', title: 'PTB330', subtitle: 'CLASS A BAROMETER', category: 'barometer', image: '/hstech/HS-TECH_files/3ca83569b6d00.jpg', gallery: ['/hstech/HS-TECH_files/3ca83569b6d00.jpg', '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg'], desc: 'High-accuracy Class A digital barometer.', specs: [{ label: 'Accuracy Class', value: 'A (±0.3 hPa)' }, { label: 'Application', value: 'Meteorology, Aviation' }] },
        { id: 'ptb210', title: 'PTB210', subtitle: 'CLASS B BAROMETER', category: 'barometer', image: '/hstech/HS-TECH_files/2e8820b69ea2b.jpg', gallery: ['/hstech/HS-TECH_files/2e8820b69ea2b.jpg'], desc: 'Industrial Class B digital barometer.', specs: [{ label: 'Accuracy Class', value: 'B (±0.5 hPa)' }, { label: 'Application', value: 'Industrial, HVAC' }] },
        { id: 'ptb110', title: 'PTB110', subtitle: 'ANALOG BAROMETER', category: 'barometer', image: '/hstech/HS-TECH_files/b2209059580dc.jpg', gallery: ['/hstech/HS-TECH_files/b2209059580dc.jpg'], desc: 'Barometric pressure transmitter with analog output.', specs: [{ label: 'Output', value: '0-1V, 0-5V, 0-10V' }, { label: 'Application', value: 'Building automation' }] },
        { id: 'ptu300', title: 'PTU300', subtitle: 'COMBINED TRANSMITTER', category: 'barometer', image: '/hstech/HS-TECH_files/deffa2b1b398f.jpg', gallery: ['/hstech/HS-TECH_files/deffa2b1b398f.jpg', '/hstech/HS-TECH_files/2e8820b69ea2b.jpg'], desc: 'Combined pressure, temperature, and humidity transmitter.', specs: [{ label: 'Parameters', value: 'P + T + RH' }, { label: 'Application', value: 'Meteorology, Environmental monitoring' }] }
    ],
    weather: [
        { id: 'wxt530', title: 'WXT530', subtitle: 'WEATHER STATION', category: 'trans', image: '/hstech/HS-TECH_files/2c2344f8b46d5.jpg', gallery: ['/hstech/HS-TECH_files/2c2344f8b46d5.jpg'], desc: 'All-in-one multi-parameter weather sensor measuring wind, rain, pressure, temperature, and humidity.', specs: [{ label: 'Parameters', value: 'Wind speed/direction, Rain, Pressure, T, RH' }, { label: 'Output', value: 'SDI-12, RS-232, RS-485, Modbus' }, { label: 'Application', value: 'Weather monitoring, Aviation, Marine' }], datasheet: 'https://www.vaisala.com/sites/default/files/documents/WXT530-Datasheet-B211961EN.pdf' },
        { id: 'hmp155_w', title: 'HMP155', subtitle: 'WEATHER PROBE', category: 'trans', image: '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg', gallery: ['/hstech/HS-TECH_files/2ddb0a75a50e4.jpg'], desc: 'High-accuracy humidity and temperature probe for meteorological applications.', specs: [{ label: 'Range', value: '0...100 %RH / -80...+60 °C' }, { label: 'Accuracy', value: '±1.0 %RH' }, { label: 'Application', value: 'Meteorology, Roads, Aviation' }, { label: 'Protection', value: 'IP66' }] },
        { id: 'hmt337', title: 'HMT337', subtitle: 'OUTDOOR TRANSMITTER', category: 'trans', image: '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg', gallery: [], desc: 'Humidity and temperature transmitter for outdoor and challenging environments.', specs: [{ label: 'Range', value: '0...100 %RH / -40...+60 °C' }, { label: 'Accuracy', value: '±1 %RH' }, { label: 'Output', value: '4...20 mA, RS-485' }, { label: 'Protection', value: 'IP65' }] },
        { id: 'ptu307', title: 'PTU307', subtitle: 'COMBINED WEATHER TRANSMITTER', category: 'trans', image: '/hstech/HS-TECH_files/deffa2b1b398f.jpg', gallery: [], desc: 'Combined pressure, humidity, and temperature transmitter for weather applications.', specs: [{ label: 'Parameters', value: 'P + T + RH' }, { label: 'Pressure range', value: '500...1100 hPa' }, { label: 'Application', value: 'Meteorology, Environmental monitoring' }] },
        { id: 'hms110', title: 'HMS110', subtitle: 'WALL/DUCT HVAC SENSOR', category: 'hvac_weather', image: '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg', gallery: [], desc: 'Combined humidity and temperature transmitter for wall/duct mounting in HVAC applications.', specs: [{ label: 'Range', value: '0...100 %RH / -40...+80 °C' }, { label: 'Output', value: '4...20 mA, 0...10 V' }, { label: 'Application', value: 'HVAC, Building automation' }] },
        { id: 'hms80', title: 'HMS80', subtitle: 'COMPACT HVAC SENSOR', category: 'hvac_weather', image: '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg', gallery: [], desc: 'Compact humidity and temperature transmitter for building automation and HVAC.', specs: [{ label: 'Range', value: '0...100 %RH' }, { label: 'Output', value: '4...20 mA, 0...10 V' }, { label: 'Application', value: 'HVAC, Building automation, Energy management' }] }
    ],
    h2o2: [
        { id: 'hpp271', title: 'HPP271/272', subtitle: 'H2O2 VAPOR PROBE', category: 'sensor', image: '/hstech/HS-TECH_files/47e994f808c6a.png', gallery: ['/hstech/HS-TECH_files/47e994f808c6a.png'], desc: 'Vaporized hydrogen peroxide measurement for bio-decontamination.', specs: [{ label: 'Gas', value: 'H2O2 vapor' }, { label: 'Application', value: 'Bio-decontamination, Sterilization' }] }
    ],

    // SETRA
    setra: [
        { id: 'setra_lite', title: 'Setra Lite', subtitle: 'VISUAL PRESSURE INDICATOR', category: 'diff_ind', image: '/hstech/HVAC_files/849fee28dfdc5.png', gallery: ['/hstech/HVAC_files/849fee28dfdc5.png'], desc: 'Visual differential pressure indicator with LED lights.', specs: [{ label: 'Display', value: 'LED light indicators' }, { label: 'Application', value: 'Cleanrooms, Operating rooms' }] },
        { id: 'setra_flex', title: 'Setra Flex', subtitle: 'ROOM PRESSURE MONITOR', category: 'diff_ind', image: '/hstech/HVAC_files/f038c293907b8.png', gallery: ['/hstech/HVAC_files/f038c293907b8.png'], desc: 'Touchscreen room pressure monitor for critical environments.', specs: [{ label: 'Display', value: 'Touchscreen' }, { label: 'Application', value: 'Isolation rooms, Cleanrooms' }] },
        { id: 'model_mrc', title: 'Model MRC', subtitle: 'MULTI-RANGE SENSOR', category: 'diff_sen', image: '/hstech/HVAC_files/0173971661ad2.png', gallery: ["/hstech/HVAC_files/0173971661ad2.png", "/hstech/HVAC_files/0b98ec3d71c52.png", "/hstech/HVAC_files/866d1ed724ffa.png", "/hstech/HVAC_files/ba117fd1862c9.png", "/hstech/HVAC_files/20542e1ba6c31.png"], desc: 'Differential pressure sensor with adjustable range.', specs: [{ label: 'Range', value: 'Field adjustable' }, { label: 'Application', value: 'HVAC, Filter monitoring' }] },
        { id: 'model_mrg', title: 'Model MRG', subtitle: 'GENERAL PURPOSE SENSOR', category: 'diff_sen', image: '/hstech/HVAC_files/0b98ec3d71c52.png', gallery: ["/hstech/HVAC_files/0b98ec3d71c52.png", "/hstech/HVAC_files/866d1ed724ffa.png"], desc: 'Cost-effective differential pressure sensor.', specs: [{ label: 'Type', value: 'General purpose' }, { label: 'Application', value: 'Building automation' }] },
        { id: 'model_264', title: 'Model 264', subtitle: 'HVAC TRANSDUCER', category: 'diff_sen', image: '/hstech/HVAC_files/866d1ed724ffa.png', gallery: ["/hstech/HVAC_files/866d1ed724ffa.png", "/hstech/HVAC_files/ba117fd1862c9.png"], desc: 'Standard differential pressure transducer for HVAC.', specs: [{ label: 'Type', value: 'Standard HVAC' }, { label: 'Output', value: '4-20mA, 0-5V, 0-10V' }] },
        { id: 'pdt101', title: 'PDT101', subtitle: 'FILTER MONITOR', category: 'diff_sen', image: '/hstech/HVAC_files/20542e1ba6c31.png', gallery: ["/hstech/HVAC_files/20542e1ba6c31.png"], desc: 'Compact OEM differential pressure sensor for filter monitoring.', specs: [{ label: 'Type', value: 'OEM sensor' }, { label: 'Application', value: 'Filter condition monitoring' }] },
        { id: 'pdt102', title: 'PDT102', subtitle: 'DIFFERENTIAL PRESSURE TRANSMITTER', category: 'diff_sen', image: '/hstech/HVAC_files/20542e1ba6c31.png', gallery: [], desc: 'High-accuracy differential pressure transmitter for HVAC and filter condition monitoring.', specs: [{ label: 'Type', value: 'Differential pressure transmitter' }, { label: 'Output', value: '4...20 mA, 0...10 V' }, { label: 'Application', value: 'HVAC, Cleanrooms, Filter monitoring' }] },
        { id: 'model_axd', title: 'Model AXD', subtitle: 'HIGH PERFORMANCE TRANSDUCER', category: 'industrial', image: '/hstech/HS-TECH_files/af2c3e1c0d3d0.png', gallery: ['/hstech/HS-TECH_files/af2c3e1c0d3d0.png'], desc: 'High accuracy industrial pressure transducer.', specs: [{ label: 'Accuracy', value: 'High precision' }, { label: 'Application', value: 'Industrial processes' }] },
        { id: 'model_206', title: 'Model 206', subtitle: 'RUGGED TRANSDUCER', category: 'industrial', image: '/hstech/HS-TECH_files/5175822708f3a.png', gallery: ['/hstech/HS-TECH_files/5175822708f3a.png'], desc: 'Rugged industrial pressure transducer with stainless steel construction.', specs: [{ label: 'Housing', value: 'Stainless steel' }, { label: 'Application', value: 'Harsh environments' }] },
        { id: 'model_209', title: 'Model 209', subtitle: 'OEM PRESSURE SENSOR', category: 'industrial', image: '/hstech/HS-TECH_files/a153aa767ba86.png', gallery: ['/hstech/HS-TECH_files/a153aa767ba86.png'], desc: 'Compact OEM pressure sensor for industrial applications.', specs: [{ label: 'Type', value: 'OEM compact' }, { label: 'Application', value: 'OEM integration' }] }
    ],

    // JUMO
    jumo: [
        { id: 'ph_sensor', title: 'tecline pH', subtitle: 'PH ELECTRODE', category: 'liquid', image: '/hstech/HS-TECH_files/1c2022c06d474.png', gallery: ['/hstech/HS-TECH_files/1c2022c06d474.png'], desc: 'High-quality pH electrode for liquid analysis.', specs: [{ label: 'Material', value: 'Glass body' }, { label: 'Application', value: 'Water treatment, Process' }] },
        { id: 'ph_trans', title: 'ecoTRANS pH 03', subtitle: 'PH TRANSMITTER', category: 'liquid', image: '/hstech/HS-TECH_files/94259b4509a1f.png', gallery: ['/hstech/HS-TECH_files/94259b4509a1f.png'], desc: 'Compact pH transmitter with DIN rail mounting.', specs: [{ label: 'Mounting', value: 'DIN rail' }, { label: 'Output', value: '4-20mA, Relay' }] },
        { id: 'dtrans_ph02', title: 'dTRANS pH 02', subtitle: 'PROCESS PH TRANSMITTER', category: 'liquid', image: '/hstech/HS-TECH_files/8d15ded8da6eb.png', gallery: ['/hstech/HS-TECH_files/8d15ded8da6eb.png'], desc: 'Industrial pH transmitter with IP65 protection.', specs: [{ label: 'Protection', value: 'IP65' }, { label: 'Application', value: 'Industrial processes' }] },
        { id: 'cond_trans', title: 'ecoTRANS Lf 03', subtitle: 'CONDUCTIVITY TRANSMITTER', category: 'liquid', image: '/hstech/HS-TECH_files/75b212a123a21.png', gallery: ['/hstech/HS-TECH_files/75b212a123a21.png'], desc: 'Conductivity transmitter for water quality monitoring.', specs: [{ label: 'Output', value: '4-20 mA' }, { label: 'Application', value: 'Water treatment' }] },
        { id: 'recording', title: 'LOGOSCREEN 600', subtitle: 'PAPERLESS RECORDER', category: 'control', image: '/hstech/HS-TECH_files/85b44cdd77766.png', gallery: ['/hstech/HS-TECH_files/85b44cdd77766.png'], desc: 'Touchscreen paperless recorder for data logging.', specs: [{ label: 'Display', value: 'Touch LCD' }, { label: 'Channels', value: 'Multi-channel' }] },
        { id: 'dtron_300', title: 'dTRON 300', subtitle: 'TEMPERATURE CONTROLLER', category: 'control', image: '/hstech/HS-TECH_files/2ddb0a75a50e4.jpg', gallery: ['/hstech/HS-TECH_files/2ddb0a75a50e4.jpg'], desc: 'Compact PID controller for temperature control.', specs: [{ label: 'Control', value: 'PID algorithm' }, { label: 'Application', value: 'Temperature processes' }] }
    ],

    // KNICK
    knick: [
        { id: 'stratos', title: 'Stratos Pro', subtitle: 'PROCESS ANALYZER', category: 'analysis', image: '/hstech/HS-TECH_files/322e267fafb41.png', gallery: ['/hstech/HS-TECH_files/322e267fafb41.png'], desc: 'High-end process analysis system with intrinsic safety.', specs: [{ label: 'Safety', value: 'Ex Zone 1 approved' }, { label: 'Application', value: 'Chemical, Pharmaceutical' }] }
    ],
