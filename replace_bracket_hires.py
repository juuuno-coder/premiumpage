...
# High-resolution image for hvac_bracket_03
src_file = "media__1770863738691.jpg"
dst_file = "hvac_wide_bracket.jpg"
...
if os.path.exists(src_path):
    ...
    print(f"✅ Successfully replaced {dst_file} with high-res image {src_file}")
else:
